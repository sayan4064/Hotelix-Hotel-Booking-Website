...
const RoomSearch = ({ handleSearchResult }) => {
  ...
  const handleInternalSearch = async () => {
    ...
    try {
      // Convert startDate to the desired format with timezone offset adjustment
      ...
      showError(error.response?.data?.message || error.message || "An error occurred during search");
    }
  };
